...
public class BananaTree extends TreeBase {

    private static Texture saplingTex   = new Texture("trees/bananatree_1.png");
    private static Texture adultTex     = new Texture("trees/bananatree_2.png");
    private static Texture harvestedTex = new Texture("trees/bananatree_3.png");
    private static Texture stumpTex     = new Texture("trees/bananatree_0.png");

    public BananaTree(float x, float y, State state) {
        super(x, y, state);
    }
